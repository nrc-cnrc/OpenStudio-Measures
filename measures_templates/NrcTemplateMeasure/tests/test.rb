...
class NrcModelMeasure_Test < Minitest::Test
  ...
  def test_sample_1()
    puts "Testing  model creation 1".blue
    ####### Test Model Creation######
	# Set output folder. This should be unique to avoid other tests writing to the same location.
    NRCMeasureTestHelper.setOutputFolder("#{@@test_dir}/test_sample_1")
    ...
    # You can save your file anytime you want.
    BTAP::FileIO::save_osm(model, "#{NRCMeasureTestHelper.outputFolder}/model.osm")
  ...
  def test_sample_2()
    puts "Testing  model creation 2".blue
  ...
  def test_sample_3()
    puts "Testing  model creation 3".blue
