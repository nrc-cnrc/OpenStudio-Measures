...
class NrcReportingMeasureStandard < OpenStudio::Measure::ReportingMeasure
  ...
  def outputs
    ...
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('hdd') # heating degree days
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('cdd') # cooling degree days
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('unmet_hours_heat_occ') # unmet hours
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('unmet_hours_cool_occ') # unmet hours
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('total_site_energy') # kWh; 4 significant figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('total_normalized_site_energy') # kWh/m2; 4 significant figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('total_normalized_necb_regulated_loads') # kWh/m2; 4 significant figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('annual_electricity_use') # kWh; 4 significant figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('annual_natural_gas_use') # GJ; 4 significant figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('bc_meui') # kWh/m2; 4 sig figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('bc_tedi') # kWh/m2; 4 sig figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('peak_electrical_demand') # kW/m2; 4 sig figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('ua_value') # W/K; 4 sig figs
    outs << OpenStudio::Measure::OSOutput.makeDoubleOutput('ua_normalized') # W/m2K; 4 sig figs
    return outs
  end
  ...
  def run(runner, user_arguments)
    ...
    output << EnergySummary.new(btap_data: btap_data, qaqc_data: qaqc_data, runner: runner)
    output << EnvelopeSummary.new(btap_data: btap_data, qaqc_data: qaqc_data, standard: @standard, runner: runner)
