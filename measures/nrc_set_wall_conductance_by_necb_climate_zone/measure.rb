...
# start the measure
class NrcSetWallConductanceByNecbClimateZone < OpenStudio::Measure::ModelMeasure
  ...
  def name
    return "NrcSetWallConductanceByNecbClimateZone"
  end

  def description
    return "Modifies wall conductances by NECB climate zone."
  end
  
  # human readable description of modeling approach
  def modeler_description
    return "Modifies wall conductances by NECB climate zone. Minimum OpenStudio 2.8.1; NRCan branch of standards (October 2019)."
  end
  ...
  def run(model, runner, user_arguments)
    ...
    surfaces.each do |surface|
      if surface.outsideBoundaryCondition == "Outdoors" and surface.surfaceType == "Wall"
        ...
        #set the wall construction according to the new conductance
...
NrcSetWallConductanceByNecbClimateZone.new.registerWithApplication
