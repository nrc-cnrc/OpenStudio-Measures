...
class NrcCreateNECBPrototypeBuilding < OpenStudio::Measure::ModelMeasure
  ...
  def modeler_description
    description = 'This will replace the model object with a brand new model.'
    description << 'It effectively ignores the seed model.'
    description << 'If there are updated tables/formulas to those in the standard they can be sideloaded into the standard definition - this new data will
